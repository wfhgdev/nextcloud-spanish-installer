...
3. Un **nombre de dominio** (ej: `nube.midominio.com`) con el registro DNS tipo **A** apuntando hacia la IP pública de tu servidor. DuckDNS recomendado!
4. Puertos **80** y **443** abiertos en tu cortafuegos/enrutador apuntando al servidor.
